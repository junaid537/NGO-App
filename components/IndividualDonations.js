...
const IndividualDonations = () => {
    ...
    const { isLoading, error, isError, data } = useQuery(
        ["unique78"],
        async () => {
        const {data} = await axios.get(`http://localhost:3000/api/v1/donation?ngoid=${role.ngoid}`, {
  ...
  return (
    ...
    <div style={{display:"flex",justifyContent:"center"}}>
        <h1 style={{fontSize:50,margin:0}}>All Donations Received</h1>
    </div>
    <div className='table'>
...
export default IndividualDonations
